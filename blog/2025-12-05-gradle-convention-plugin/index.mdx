...
authors: [way]
tags: [android,gradle-convention-plugin,mts,한국투자증권,한투]
---
...
국내 MTS 프로젝트에 합류하면서 적용하게 된 Gradle Convention Plugin에 대해 설명해드리겠습니다.<br/>
...
```kotlin
class AndroidLibrarySampleConventionPlugin : Plugin<Project> {
